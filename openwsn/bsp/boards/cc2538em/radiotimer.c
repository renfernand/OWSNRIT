...
volatile uint32_t radiotimer_freerun2=0;
...
void radiotimer_schedule_us(PORT_RADIOTIMER_WIDTH offset) {
	...
	//period = radiotimer_getPeriod();
	//period = getdeltaslotperiod_ms();
    //TESTES MOSTRARAM QUE SEMPRE ELE TEM UM ATRASO DE aproximadamente 8us a Mais
	// 1us (configurado) = 8.3us (osciloscopio)
	// 10us              = 19us
	// 50us              = 58us
	// 100us             = 108us
	// 150us             = 159us
...
#endif
/*
 * Retorna o tempo (em ticks) decorrido desde o inicio do slot time
 */
