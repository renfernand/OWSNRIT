...
#define RX_RIT_PERIOD_MS            150
#define RX_RIT_TXOLAPREPARE_MS        1
#define RX_RIT_TXOLAECHO_MS          10
#define RX_RIT_DELAY_TX_TO_RX_MS      5
#define RX_RIT_TIMEOUT_MS           100
#define RX_RIT_ACKECHO_TIMEOUT_MS    50
