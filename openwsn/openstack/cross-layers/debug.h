...
/*
#define RECORD_RADIO_TX_ON   	{  LEDS_TX_ON   }

#define RECORD_RADIO_RX_ON   	{ LEDS_RX_ON  }

#define RECORD_RADIO_TX_OFF(a)   	{ LEDS_TX_OFF   }

#define RECORD_RADIO_RX_OFF(a)   	{ LEDS_RX_OFF   }
