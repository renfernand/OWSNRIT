...
This was done on 2015-10-30 10:48:37.255000.
*/
...
bool topology_isAcceptablePacket(OpenMote* self, ieee802154_header_iht* ieee802514_header) {
   ...
   if (IsMyNeighboor( idmanager_getMyID(self, ADDR_64B)->addr_64b[7],ieee802514_header->src.addr_64b[7])) 
   {
  	 returnVal=TRUE;
   }
   return returnVal;
